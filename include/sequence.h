...
class staticSequence : public Sequence<Key> {
 public:
  ...
  Key Sequence<Key>::operator[](const Position& p) const {
    return block_[p];
  }
...
//  public:
//   dynamicSequence(){
//     // No es necesario hacer nada aquí, ya que el vector se inicializa vacío
//     automáticamente
//   }
...
//   bool Is_full() const{
//     // Devuelve verdadero si el tamaño del vector alcanza cierto límite (por
//     ejemplo, 100) return (list_.size() >= 100); // Puedes ajustar el límite
//     según sea necesario
//   }

//  private:
//   std::vector<Key> list_; // Usa Key en lugar de int para hacer la clase más
//   genérica
// };
